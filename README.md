...
Запуск WG Easy в Docker: запускает WG Easy в контейнере Docker, используя параметры, такие как сгенерированный хеш пароля, IP-адрес сервера и порты 51820/UDP и 51821/TCP для доступа к панели.
...
Этот файл `README.md` содержит всю необходимую информацию для пользователя, включая команду для быстрой установки, описание работы скрипта, и пример вывода, чтобы пользователи знали, чего ожидать после установки.
